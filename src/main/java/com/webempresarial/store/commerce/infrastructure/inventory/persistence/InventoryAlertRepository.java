...
public interface InventoryAlertRepository
    ...
    @Query("""
        ...
        ORDER BY
            CASE a.level
                WHEN com.webempresarial.store.commerce.domain.inventory.InventoryAlertLevel.OUT_OF_STOCK
                    THEN 1
                WHEN com.webempresarial.store.commerce.domain.inventory.InventoryAlertLevel.CRITICAL
                    THEN 2
                ELSE 3
            END,

...
public interface OrderRepository extends JpaRepository<Order, Long> {
    ...
    @Query("""
        ...
        LEFT JOIN FETCH i.producto
        LEFT JOIN FETCH i.variante
        WHERE o.orderStatus = com.webempresarial.store.commerce.domain.order.OrderStatus.CREATED
        AND o.paymentMethod = com.webempresarial.store.commerce.domain.order.Order.PaymentMethod.TRANSFER
        AND o.store = :store
    """)
    ...
    @Query("""
        ...
        JOIN oi.order o
        JOIN oi.producto p
        WHERE o.paymentStatus = com.webempresarial.store.commerce.domain.order.PaymentStatus.PAID
        AND o.store = :store
